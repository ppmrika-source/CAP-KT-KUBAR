...
# -----------------------------
st.set_page_config(page_title="Aplikasi CAP-KT Kutai Barat", layout="wide")

st.title("📊CAP-KT Kutai Barat")
...
if menu == "Input Data":
    ...
    if st.button("💾 Simpan Data"):
	    ...
	    "Kampung": kampung,
            ...
            "Nama Pengurus & Anggota": Nama_pengurus_anggota,
            "Nomor Registrasi/No. Akta Notaris Kelompok": Nomor_Registrasi/_No_Akta_Notaris_Kelompok,
...
with st.form("form_berbagi_data"):
    ...
    unit_kerja = st.text_input("Unit Kerja Pengupload", ["Badan Perencanaan Pembangunan Penelitian & Pengembangan Daerah","Badan Pendapatan Daerah","Badan Kepegawaian dan Pengembangan Sumber Daya Manusia", "Badan Keuangan dan Aset Daerah", "Badan Kesatuan Bangsa dan Politik", "Badan Penanggulangan Bencana Daerah","Inspektorat Daerah","Dinas Pendidikan dan Kebudayaan","Dinas Kesehatan", "Dinas Pekerjaan Umum dan Penataan Ruang", "Dinas Perumahan, Kawasan Pemukiman dan Pertanahan", "Satuan Polisi Pamong Praja","Dinas Sosial", "Dinas Pengendalian Penduduk, Keluarga Berencana, Pemberdayaan Perempuan dan Perlindungan Anak", "Dinas Tenaga Kerja dan Transmigrasi", "Dinas Kependudukan dan Pencatatan Sipil","Dinas Pemberdayaan Masyarakat dan Kampung", "Dinas Perhubungan", "Dinas Komunikasi dan Informatika", "Dinas Penanaman Modal dan Pelayanan Terpadu Satu Pintu","Dinas Pemuda dan Olahraga","Dinas Arsip dan Perpustakaan","Dinas Ketahanan Pangan", "Dinas Lingkungan Hidup", "Dinas Perdagangan, Koperasi, Usaha Kecil dan Menengah", "Dinas Pariwisata","Dinas Pertanian","Dinas Perikanan","UPT Revitalisasi Perkebunan", "UPT Agrobisnis Pertanian", "UPTD Balai Benih Ikan Mentiwan", "Bongan","Jempang","Penyinggahan","Muara Pahu","Damai", "Melak", "Barong Tongkok", "Sekolaq Darat","Mook Manaar Bulatn","Tering","Nyuatan", "Bentian Besar", "Linggang Bigung", "Siluq Ngurai","Long Iram","Muara Lawa"])
